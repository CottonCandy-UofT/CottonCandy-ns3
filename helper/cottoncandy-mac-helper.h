...
#ifndef COTTONCANDY_MAC_HELPER_H
#define COTTONCANDY_MAC_HELPER_H
...
public:
  ...
  void SetAddressGenerator (Ptr<CottoncandyAddressGenerator> generator);
   ...
   */
  Ptr<CottoncandyMac> Create (Ptr<Node> node, Ptr<NetDevice> device) const;
...
private:
  ...
  Ptr<CottoncandyAddressGenerator> m_addrGenerator = 0;
};
