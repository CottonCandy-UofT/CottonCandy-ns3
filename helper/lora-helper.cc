      ...
      if (m_packetTracker)
        {
          if (phyHelper.GetDeviceType () ==
              TypeId::LookupByName ("ns3::SimpleEndDeviceLoraPhy"))
            {
              ...
              mac->TraceConnectWithoutContext("ChannelSelected",
                                              MakeCallback
                                                  (&LoraPacketTracker::CottoncandyChannelSelectionCallback,
                                                  m_packetTracker));

              mac->TraceConnectWithoutContext("NumInterferers",
                                              MakeCallback
              ...
              mac->TraceConnectWithoutContext("DCPDuration",
                                              MakeCallback
                                                  ...
                                                  m_packetTracker));
              mac->TraceConnectWithoutContext("EnergyConsumption",
                                              MakeCallback
                                                  (&LoraPacketTracker::CottoncandyEnergyReportCallback,
                                                  m_packetTracker));                                     
