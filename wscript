...
def build(bld):
    ...
    module.source = [
        ...
        'model/cottoncandy-gatewayreq-header.cc',
        'model/cottoncandy-seekjoin-header.cc',
        'model/cottoncandy-nodereply-header.cc',
        'model/cottoncandy-nodereply-embedded-header.cc',
        'model/cottoncandy-channel-selector.cc',
    ...
    headers.source = [
        ...
        'model/cottoncandy-gatewayreq-header.h',
        'model/cottoncandy-seekjoin-header.h',
        'model/cottoncandy-nodereply-header.h',
        'model/cottoncandy-nodereply-embedded-header.h',
        'model/cottoncandy-channel-selector.h',
        'model/lorawan-mac.h',
        'model/lora-phy.h',
